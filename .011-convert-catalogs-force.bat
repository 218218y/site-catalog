...
python tools\build_catalogs.py --force --format webp --dpi 220 --max-width 2800 --max-height 2800 --medium-size 1600 --thumb-size 420 --quality 84 --medium-quality 82 --thumb-quality 76 --sharpen 0.8 --ocr auto --ocr-lang heb+eng --ocr-dpi 260
if errorlevel 1 goto error
echo.
echo Forced responsive WebP conversion finished. Every remaining PDF was rebuilt.
