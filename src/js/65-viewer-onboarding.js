...
function viewerNavigationOnboardingCopy() {
  if (viewerHasTouchCapability()) {
    return "במסך מגע החליקו למעלה, למטה, ימינה או שמאלה כדי לעבור עמוד. אפשר גם להשתמש בחצים שבצדי המסך או במקשי החצים ו־Page Up/Down.";
  }
  return "גללו בעכבר או במשטח המגע, לחצו על החצים שבצדי המסך, או השתמשו במקשי החצים ו־Page Up/Down.";
}
