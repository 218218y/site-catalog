...
אם כבר קיימות תמונות תקינות ב-`assets/pages`, הסקריפט מדלג עליהן ולא ממיר מחדש בלי צורך. הבדיקה מתבססת על ה-PDF ועל הגדרות התמונה בלבד; שינוי בהגדרות OCR לא גורם לבנייה מחדש של קטלוג שכבר הומר. כדי לבנות מחדש את התמונות באיכות החדשה, הרץ `convert-catalogs-force.bat`.
