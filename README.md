...
הבדיקה המלאה יוצרת גם חבילת Cloudflare Pages נקייה בתיקייה זמנית, מאמתת אותה ומוחקת את התיקייה בסיום. אין ל־npm תלויות חיצוניות בפרויקט; `package.json` משמש רק כממשק פקודות אחיד.
