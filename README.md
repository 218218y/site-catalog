...
2. אימות שכל ששת דפי האתר תואמים לתבניות ול־footer המשותף.
...
בדיקות Playwright מכסות פתיחת קטלוג, מעבר עמודים, חיפוש, שמירת מועדף לאחר רענון, קישור ישיר, חזרה מהצופה, מובייל ושינוי orientation, כשל תמונה, ניווט מקלדת ובדיקות צילום מסך. תמונות הקטלוג נענות בבדיקות באמצעות fixture מקומי, ולכן הבדיקות אינן תלויות ב־R2 או באינטרנט.
