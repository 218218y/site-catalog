...
if errorlevel 1 (
  echo.
  echo Site build stopped because catalog image files or their generated metadata changed after the last R2 sync.
  echo Run .07-sync-r2-images.bat once, then run this file again.
  pause
  exit /b 1
)
