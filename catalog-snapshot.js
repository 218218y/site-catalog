 ...
 *
 * Bundled as a side-effect-free ES module only into the Viewer route.
 */

const EXPORT_MIME = 'image/jpeg';
const EXPORT_EXTENSION = 'jpg';
const EXPORT_QUALITY = 0.82;
const MAX_EXPORT_EDGE = 2200;
const LOGO_WIDTH_RATIO = 0.13;
const LOGO_TOP_RATIO = 0.02;
const LOGO_ASPECT_RATIO = 786 / 317;
const LOGO_ASSET_PATH = 'brand-logo.svg';
const SNAPSHOT_CORS_VERSION = '1';

/** @param {unknown} src @returns {URL|null} */
...
/** @param {HTMLImageElement} img @returns {{width: number, height: number}} */
...
/** @param {CanvasRenderingContext2D} ctx @param {HTMLCanvasElement} canvas @returns {Promise<boolean>} */
...
/** @param {string} src @returns {Promise<Blob>} */
...
const catalogSnapshotApi = Object.freeze({
  buildSnapshotBlob,
  extension: EXPORT_EXTENSION
});

export { buildSnapshotBlob };
export default catalogSnapshotApi;
