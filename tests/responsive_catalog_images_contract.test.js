...
const scrollViewer = fs.readFileSync(path.join(root, "src/js/58-viewer-scroll.js"), "utf8");
...
assert.match(scrollViewer, /const radius = catalogNeighborPreloadRadius\(\);/);
assert.match(scrollViewer, /viewerPageImageRequest\(catalog, page\)/);
