...
assert.match(viewerImage, /viewerPageSrc\(navigationState\.catalog, page, requestOptions\)/);
...
assert.match(viewer, /viewerPageImageRequest\(catalog, navigationState\.page, \{[\s\S]*?forceFull: preserveFullResolutionTier[\s\S]*?\}\)/);
