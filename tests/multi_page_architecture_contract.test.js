...
assert.match(app, /navigateTo\(viewerDocumentUrl\(catalog\.id, page, \{ source \}\)\)/);
...
assert.match(app, /function shareCurrentMainHeaderLink\([\s\S]*?shareOrCopyCurrentLink\(favoritesElements\.headerCopyLink\)/);
