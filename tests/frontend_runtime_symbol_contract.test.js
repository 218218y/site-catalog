...
assert.match(checker, /runTypeScriptCompiler/);
assert.match(checker, /extractDiagnosticCodes/);
assert.match(checker, /error TS2304:/);
assert.doesNotMatch(checker, /\bcreateProgram\b|\bScriptTarget\b|\bModuleKind\b/);
