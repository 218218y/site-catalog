...
assert.match(app, /const VIEWER_SCROLL_ZOOM_EXIT_BUFFER_VIEWPORT_RATIO = 0\.24;/);
assert.match(app, /const VIEWER_SCROLL_ZOOM_EXIT_BUFFER_MIN_PX = 96;/);
assert.match(app, /const VIEWER_SCROLL_ZOOM_EXIT_BUFFER_MAX_PX = 220;/);
...
assert.match(css, /\.viewer-scroll-pages\s*\{[\s\S]*?gap:\s*clamp\(14px, 2vh, 22px\);/);
