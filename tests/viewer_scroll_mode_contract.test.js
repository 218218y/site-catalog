...
assert.match(app, /const VIEWER_SCROLL_WHEEL_ELASTIC_RATIO = 0\.42;/);
...
assert.match(app, /elasticRemainder \* VIEWER_SCROLL_WHEEL_ELASTIC_RATIO/);
...
assert.match(css, /\.viewer-scroll-pages\.viewer-wheel-gesture-active\s*\{[\s\S]*?scroll-snap-type:\s*none;/);
