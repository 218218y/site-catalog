...
assert.match(app, /lightboxMobileSearchToggle: \$requiredButton\("lightboxMobileSearchToggle"\)/);
assert.match(app, /lightboxMobileSearchClose: \$requiredButton\("lightboxMobileSearchClose"\)/);
