...
assert.equal(packageJson.scripts["verify:seo:public"], "python tools/verify_public_seo.py --out .artifacts/public-seo-preview");
assert.equal(packageJson.scripts["verify:seo:live"], "python tools/audit_public_seo.py --live");
